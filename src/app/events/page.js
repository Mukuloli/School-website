    ...
    return (
        <div className="min-h-screen bg-neutral-50">
            <section className="pt-32 pb-16 text-center">
                <ScrollReveal>
                    <span className="badge-info mb-4">Celebrations & Activities</span>
            ...
            <div className="max-w-6xl mx-auto px-4 pb-24">
                <ScrollReveal>
                    <div className="bg-white rounded-[3rem] overflow-hidden shadow-2xl border border-neutral-100 grid md:grid-cols-2">
                        {/* Visual Side */}
                        <div className="bg-gradient-to-br from-purple-900 to-blue-900 relative min-h-[400px] flex items-center justify-center overflow-hidden">
